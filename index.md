...
Following is a list of video and other resources that are periodically updated for learning MetaBuild:
...
* [MetaBuild Deep Dive 8 - Meta project](video_dd8.md)
* [MetaBuild Deep Dive 9 - Builtin config, defines, option, flavor and build_spec](video_dd9.md)
* [MetaBuild Deep Dive 10 - Option and flavor examples, using `gen_rule` to add a custom preprocessing step/tool](video_dd10.md)
